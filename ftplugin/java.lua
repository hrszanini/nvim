...
local installation_path_lsp = mason_registry.get_package("jdtls"):get_install_path()
local installation_path_dap = mason_registry.get_package("java-debug-adapter"):get_install_path()
